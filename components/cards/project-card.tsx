    ...
    >
      ...
      >
        <section className="flex flex-col">
          <h2 className="text-lg sm:text-xl md:text-2xl mb-4 font-semibold">{title}</h2>
          <p className="text-xs sm:text-sm md:text-base font-normal">{description}</p>
        </section>
        ...
        <section className="flex justify-between items-center">
          ...
          <AppButton
            className="border-blue-light hover:bg-gradient-to-r from-blue-dark to-blue-light hover:border-0 font-medium"
            variant="bordered"
